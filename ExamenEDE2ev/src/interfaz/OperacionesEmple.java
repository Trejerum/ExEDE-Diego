...
public class OperacionesEmple extends JDialog {
	...
	public final class modificarEmp implements ActionListener {
	...
	public final class borrarEmp implements ActionListener {
	...
	public final class consultarEmp implements ActionListener {
	...
	public final class insertarEmp implements ActionListener {
	...
	public OperacionesEmple() {
		...
		btnInsertar.addActionListener(new insertarEmp());
		
		//Accion boton consultar
		btnConsultar.addActionListener(new consultarEmp());
		
		//Accion boton borrar
		btnBorrar.addActionListener(new borrarEmp());
		
		//Accion boton modificar
		btnModificar.addActionListener(new modificarEmp());
	}
}
